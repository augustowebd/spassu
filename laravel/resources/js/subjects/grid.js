        ...
        try {
            ...
            data.data.forEach((item, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary edit-btn" data-id="${item.codAs}">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger remove-btn" data-id="${item.codAs}">
            ...
            document.querySelectorAll('.edit-btn').forEach(btn => {
                btn.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        // Preencher campos
                        document.getElementById("edit_id").value = item.codAs;
                        document.getElementById("edit_description").value = item.descricao;
